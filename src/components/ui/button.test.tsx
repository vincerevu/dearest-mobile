...
describe('button component ', () => {
  ...
  it('should apply correct styles based on size prop', () => {
    ...
    const expectedStyle
      = 'font-quicksand font-semibold text-white text-xl';
    const receivedStyle
  ...
  it('should apply correct styles for label when variant is secondary', () => {
    ...
    const expectedStyle
      = 'font-quicksand font-semibold text-primary-700 text-base';
    const receivedStyle
      = button.props.children[0].props.children.props.className;
    expect(receivedStyle).toContain(expectedStyle);
  });
  it('should apply correct styles for label when is disabled', () => {
    ...
    const expectedStyle
      = 'font-quicksand font-semibold text-base text-neutral-600';
    const receivedStyle
      = button.props.children[0].props.children.props.className;
    expect(receivedStyle).toContain(expectedStyle);
  });
