...
export function PartnerTask({ completed, onToggle, title }: { title: string; completed: boolean; onToggle: () => void }) { return <Chip label={`${completed ? '✓ ' : ''}${title}`} selected={completed} onPress={onToggle} />; }
